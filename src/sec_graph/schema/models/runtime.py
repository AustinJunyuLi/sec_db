...
CREATE TABLE progress_ledger (
  ...
  state VARCHAR NOT NULL CHECK (state IN ('queued', 'ingested', 'evidence_mapped', 'llm_artifacts_written', 'claims_imported', 'reconciled', 'judgments_derived', 'validated', 'projected', 'blocked')),
